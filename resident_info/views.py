...
def node_create(request):
    ...
    if request.method == 'POST':
        data = {
            ...
            'other_id_type_id': request.POST.get('other_id_type') or None,
            'other_id_number': request.POST.get('other_id_number', '').strip() or None,
            ...
            'move_to_place': request.POST.get('move_to_place', '').strip(),
            'is_deceased': request.POST.get('is_deceased') == 'on',
            'death_date': request.POST.get('death_date') or None,
            'death_reason': request.POST.get('death_reason', '').strip(),
    ...
    return render(request, 'resident_info/edit.html', {
        ...
        'other_id_types': get_taxonomy_items('other_id_type'),
        'resident_types': get_taxonomy_items('resident_type'),
        'grids': get_taxonomy_items('grid'),
